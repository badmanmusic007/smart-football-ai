    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            body { font-family: -apple-system, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px; background-color: #f8f9fa; color: #333; }
                ...
                resultDiv.innerHTML = `
                    <div class="animate-in">
                        ...
                        <div class="prob-grid">
                            ...
                            <div class="prob-box"><div>✈️ ${away}</div><strong>${data.away_win}%</strong></div>
                        </div>
