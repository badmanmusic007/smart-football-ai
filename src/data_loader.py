...
class FootballDataLoader:
    ...
    def load_data(self):
        ...
        # User-Agent is required to avoid connection drops (403/Remote End Closed)
        headers = {
        ...
        for url in settings.DATA_URLS:
            try:
                # Use urllib which handles macOS SSL quirks better than requests in some envs
                ...
                stats_cols = ['HS', 'AS', 'HST', 'AST', 'HC', 'AC', 'HY', 'AY', 'HR', 'AR', 'B365H', 'B365D', 'B365A', 'B365>2.5', 'B365<2.5', 'B365BTTSY', 'B365BTTSN']
